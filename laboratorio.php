    ...
    <body style="margin: 0px;">
        ...
        <div class="content">
            <div class="table-title">
                <?php 
                    if($day == 0)
                        echo "<h3>Complessivo - ".$laboratori[$_GET['labID']]."</h3>";
                    else
                        echo "<h3>Giorno ".$day." (".$date[$day - 1].") - ".$laboratori[$_GET['labID']]."</h3>";
                ?>
            </div>
                ...
                <table class="table-fill">
                    ...
                    <tbody class="table-hover">
                        <?php
                            ...
                            $sql = "SELECT Nome, Eta, LabID, Presenza1, Presenza2, Presenza3, Presenza4, Sport FROM Generale WHERE labID = '" . $_GET['labID'] . "'";
                            $result = $conn->query($sql);
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
									...
									//sport
									echo "<td value=". $row['Sport']. ">";
									if( $row["Sport"] != 99 ) { echo $sport[$row['Sport']]; }
									else{ echo "N/A"; }
									echo " </td></tr>" ;
                                }
                            } else {
